  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        leading: IconButton(
          onPressed: () => Get.back(result: controller.isNoteUpdated.isTrue),
      ...
      body: GetX<NoteDetailController>(
        init: NoteDetailController(),
        initState: (_) {},
        builder: (_) {
          return Padding(
            padding: const EdgeInsets.all(15.0),
            child: controller.noteDetailViewState.value ==
                    NoteDetailViewState.data
